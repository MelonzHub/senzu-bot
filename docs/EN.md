# Senzu Bot Documentation (EN)
This document covers setup, configuration, and plugin development for Senzu Bot.
...
## Plugin Structure
Senzu Bot supports two plugin types: command and event.
